...
const experiences = [
  {
    ...
    role: { en: 'AI Engineer — CEO Office, Manufacturing', de: 'KI-Ingenieur — CEO-Büro, Fertigung' },
    ...
    headline: {
      en: 'Drove AI, BI, and data initiatives across Suzlon\'s manufacturing organisation — 10 plants in Asia and Europe, 300+ daily users, 14 BI dashboards, 7 production GenAI bots, 250+ KPIs.',
      de: 'Trieb KI-, BI- und Daten-Initiativen in Suzlons Fertigungsorganisation voran — 10 Werke in Asien und Europa, 300+ tägliche Nutzer, 14 BI-Dashboards, 7 produktive GenAI-Bots, 250+ KPIs.',
    },
    points: {
      en: [
        ...
        'Worked in a 6-person engineering team to build Suzlon\'s Manufacturing Control Tower — a consolidated executive view of 250+ KPIs across SQPDCME (Safety, Quality, Productivity, Delivery, Cost, Manpower, Environment).',
        'Helped rebuild Suzlon\'s monthly Manufacturing Business Review — sourced and modelled data from 50+ operational systems and deployed agentic AI that answers live questions with on-the-fly charts, cutting manual dashboard and Excel reporting.',
        'Contributed to Suzlon\'s AI, Data & Digitisation roadmap — the operating model, tooling stack, and rollout plan.',
      ],
      de: [
        ...
        'Arbeitete in einem 6-köpfigen Engineering-Team am Aufbau von Suzlons Manufacturing Control Tower — einer konsolidierten Executive-Sicht auf 250+ KPIs über SQPDCME (Sicherheit, Qualität, Produktivität, Lieferung, Kosten, Personal, Umwelt).',
        'Half, Suzlons monatliches Manufacturing Business Review neu aufzubauen — Aggregation und Modellierung von Daten aus 50+ operativen Systemen sowie agentenbasierte KI, die Live-Fragen mit dynamischen Charts beantwortet und manuelle Dashboard- und Excel-Reports reduziert.',
        'Trug zu Suzlons Roadmap für KI, Daten & Digitalisierung bei — Operating Model, Tooling-Stack und Rollout-Plan.',
      ],
    },
    Anim: WindTurbineSVG,
