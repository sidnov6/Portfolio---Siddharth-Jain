    ...
    <div className="border border-[#E4E0D6] rounded-2xl bg-white shadow-sm overflow-hidden">
      ...
      <div className="flex items-center justify-between px-5 py-3 border-b border-[#E4E0D6] bg-[#F8F5EE]">
        <div className="flex items-center gap-2">
          ...
          <p className="text-[11px] font-mono uppercase tracking-[0.18em] text-[#6E7A70]">Resume · A4 · Garamond · one page</p>
        </div>
        <div className="flex items-center gap-2">
          <a
            href="/resume"
            target="_blank"
            onClick={() => track('click', { link: 'resume_open_standalone' })}
          ...
          >
            <Printer size={12} /> Open standalone
          </a>
          <a
            href="/api/resume/pdf"
      ...
      <div className="px-8 sm:px-12 py-8 max-h-[760px] overflow-y-auto">
